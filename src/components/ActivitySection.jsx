...
export default function ActivitySection() {
  ...
  const card3CustomSummaries = {
    ...
    'c3-snb-new-business-property': ['Signed App', 'Signed client consent', 'Any signed forms for declinded coverages if needed', 'Signed MAC if monthly payments',  'VOID cheque', 'iClarify for Homeowners & bareland condo', '#Set abeyance to SNB - 3 Support', '#Get credit consent over phone before letting client go'],
